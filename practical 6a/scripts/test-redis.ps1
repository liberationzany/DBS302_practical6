...
docker compose exec redis redis-cli --tls --cacert /certs/redis/ca.crt -u rediss://app_user:appStrongPwd@127.0.0.1:6379 SET session:user123 data
docker compose exec redis redis-cli --tls --cacert /certs/redis/ca.crt -u rediss://app_user:appStrongPwd@127.0.0.1:6379 GET session:user123
...
docker compose exec redis redis-cli --tls --cacert /certs/redis/ca.crt -u rediss://monitoring:monitorPwd@127.0.0.1:6379 SET session:monitor nope
